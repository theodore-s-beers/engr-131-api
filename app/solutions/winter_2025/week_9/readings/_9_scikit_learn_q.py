...
solutions: dict[str, Any] = {
    ...
    "q1-9-pipeline": 'True',
    "q3-1-supervised-learning": ['`LinearRegression`', '`KNeighborsClassifier`', '`RandomForestClassifier`'],
    "q3-2-feature-scaling": ['`MinMaxScaler`', '`StandardScaler`', '`Normalizer`'],
    "q3-3-model-selection": ['`sklearn.model_selection`', '`sklearn.metrics`'],
    "q3-4-dimensionality-reduction": ['`PCA`', '`TruncatedSVD`', '`LinearDiscriminantAnalysis`'],
}
