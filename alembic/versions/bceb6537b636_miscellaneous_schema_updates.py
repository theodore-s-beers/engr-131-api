...
def upgrade() -> None:
    ...
    op.create_table('scoring_submissions',
    ...
    sa.ForeignKeyConstraint(['assignment'], ['assignments.title'], ),
    ...
    op.drop_table('exams')
    op.add_column('assignment_submissions', sa.Column('assignment', sa.String(), nullable=False))
    op.drop_constraint('assignment_submissions_assignment_id_fkey', 'assignment_submissions', type_='foreignkey')
    op.create_foreign_key(None, 'assignment_submissions', 'assignments', ['assignment'], ['title'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('assignment_submissions', sa.Column('assignment_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'assignment_submissions', type_='foreignkey')
    op.create_foreign_key('assignment_submissions_assignment_id_fkey', 'assignment_submissions', 'assignments', ['assignment_id'], ['id'])
    ...
    sa.ForeignKeyConstraint(['student_email'], ['students.email'], name='exam_submissions_student_email_fkey'),
