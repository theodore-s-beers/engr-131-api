...
def downgrade() -> None:
    ...
    sa.Column('late_assignment_percentage', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('submitted_score', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('current_max_score', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
